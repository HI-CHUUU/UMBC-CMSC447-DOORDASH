 ...
 * * FINAL MASTER VERSION (Release 3.0)
 * *
 * * INTEGRATED FEATURES:
 * * 1. Role-Based Access Control (RBAC)
 * * 2. User Approval Workflow (is_approved flag)
 * * 3. Detailed Order Lifecycle Timestamps
 * * 4. Real-World UMBC Venue & Menu Data
 */

-- Initialize database with UTF-8 support for emoji compatibility (e.g. 🍕, 🍔)
...
CREATE TABLE IF NOT EXISTS users (
  ...
  -- Security: Customers are auto-approved (1), Dashers/Restaurants start as pending (0)
...
-- =============================================
-- 6. ORDERS (CENTRAL TRANSACTION TABLE)
-- =============================================
CREATE TABLE IF NOT EXISTS orders (
  ...
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, -- Time Ordered
  accepted_at DATETIME NULL,                      -- Time Restaurant Accepted
  ready_at DATETIME NULL,                         -- Time Marked Ready (Food Done)
  picked_up_at DATETIME NULL,                     -- Time Dasher Picked Up
  delivered_at DATETIME NULL,                     -- Time Delivered to Customer
